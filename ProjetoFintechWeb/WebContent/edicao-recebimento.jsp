...
<body>
	<div class="container">
        <div class="tittle-entidades"><p>Editar Recebimento</p>
        </div>
		
		<form action="recebimento" class="form-recebimento" method="post">
        	<input type="hidden" value="editar" name="acao">
			<input type="hidden" value="${recebimento.codigoRecebimento}" name="codigoRecebimento">
			<div class="form-cadastro-recebimento">
				<img src="./image/VALOR.png" alt="valor"> <input type="text" name="valor" class="form-control-recebimento" value="${recebimento.valor}">
			</div>
			<div class="form-cadastro-recebimento">
				<img src="./image/DESCRICAO.png" alt="descricao"> <input type="text" name="descricao" class="form-control-recebimento" value="${recebimento.descricao}">
			</div>
			<div class="form-cadastro-recebimento">
				<img src="./image/DATA.png" alt="data_recebimento"> <input type="text" name="dataRecebimento" class="form-control-recebimento" 
				value='<fmt:formatDate value="${recebimento.dtRecebimento.time }" pattern="dd/MM/yyyy"/>'>
			</div>
			
			 <div>
			<input type="submit" value="Salvar" class="salvarEditar"> 
			<a href="recebimento?acao=listar" class="cancelarEditar">Cancelar</a>
			</div>
